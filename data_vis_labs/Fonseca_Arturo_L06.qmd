...
ggplot(tech_stocks, aes(date, price_indexed, group = company)) +
  ...
  labs(x = NULL, y = NULL, subtitle = "Stock price, indexed") +
  theme_minimal() +
...
ggplot(cdc_small, aes(height, weight, color = genhlth, shape = genhlth)) +
  scale_x_continuous(limits = c(55, 80), breaks = scales::breaks_width(5), labels = scales::label_number(suffix = " in")) +
  scale_y_continuous(limits = c(100, 300), trans = "log10", breaks = scales::breaks_width(25), labels = scales::label_number(suffix = " lbs")
) +
  geom_point(size = 3) +
  labs(
    x = NULL,
